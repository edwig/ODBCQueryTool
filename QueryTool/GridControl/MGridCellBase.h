...
class MCGridCellBase : public CObject
{
    friend class MCGridCtrl;
    DECLARE_DYNAMIC(MCGridCellBase)

// Construction/Destruction
public:
    MCGridCellBase();
    virtual ~MCGridCellBase();
...
public:
    ...
    virtual void SetSQLType(int sqlType)                    = 0 ;
    ...
    virtual void SetGrid(MCGridCtrl* /* pGrid */)           = 0 ;
    ...
    virtual MCGridCtrl* GetGrid()      const                = 0 ;
    virtual CWnd     * GetEditWnd()    const                = 0 ;
    virtual UINT       GetMargin()     const                = 0 ;

    virtual MCGridCellBase* GetDefaultCell() const;
...
// Operators
public:
    virtual void operator=(const MCGridCellBase& cell);
