...
MCInPlaceEdit::MCInPlaceEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
...
MCInPlaceEdit::~MCInPlaceEdit()
{
}

BEGIN_MESSAGE_MAP(MCInPlaceEdit, CEdit)
...
void MCInPlaceEdit::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags) 
{
...
void MCInPlaceEdit::OnKillFocus(CWnd* pNewWnd)
{
    CEdit::OnKillFocus(pNewWnd);
    EndEdit();
}

void MCInPlaceEdit::OnChar(UINT nChar, UINT nRepCnt, UINT nFlags)
{
...
UINT MCInPlaceEdit::OnGetDlgCode() 
{
...
BOOL MCInPlaceEdit::PreTranslateMessage(MSG* pMsg) 
{
...
// Auto delete
void MCInPlaceEdit::PostNcDestroy() 
{
    CEdit::PostNcDestroy();
