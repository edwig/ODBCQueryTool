...
#ifndef __OEBlockPage_h__
#define __OEBlockPage_h__
...
class COEBlockPage : public CPropertyPage
{
public:
	COEBlockPage (SettingsManager& manager);
	~COEBlockPage ();

	//{{AFX_DATA(COEBlockPage)
