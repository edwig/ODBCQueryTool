...
class COEPrintPageSetup : public StyleDialog
{
public:
  ...
  StyleEdit   m_editHeader;
  StyleEdit   m_editFooter;
  StyleEdit   m_editLeft;
  StyleEdit   m_editRight;
  StyleEdit   m_editTop;
  StyleEdit   m_editBottom;
...
public:
//     DECLARE_MESSAGE_MAP()
//     afx_msg void OnEnChangePpsHeader();
};
