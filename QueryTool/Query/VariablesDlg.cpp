...
VariablesDlg::OnInitDialog()
{
  ...
  SetWindowText(_T("Variables (binding)"));
  ...
  XString str;
  m_variable1->GetAsString(str);
  m_variableString1 = str;
  ...
  m_variable2->GetAsString(str);
  m_variableString2 = str;
  ...
  m_variable3->GetAsString(str);
  m_variableString3 = str;
  ...
  m_variable4->GetAsString(str);
  m_variableString4 = str;
...
VariablesDlg::OnCbnSelchangeInout1()
{
  ...
  if(num >= 0)
  {
    ...
    int type = SQLDataType::FindParamtype((LPTSTR)typeName.GetString());
